      ...
      <div className="mx-auto max-w-5xl px-4 py-6">
        ...
        <div className="rounded-xl border border-gray-200 bg-white p-5">
          ...
          <div className="mt-4 flex items-center gap-3">
            ...
            <button
              ...
              disabled={uploading}
              className="rounded-lg bg-black px-5 py-2.5 text-sm text-white transition-opacity hover:opacity-80 disabled:opacity-40"
            >
        ...
        <div className="mt-6">
          ...
          {loading ? (
            ...
            <p className="mt-4 text-sm text-gray-400">아직 등록된 사진이 없습니다.</p>
          ) : (
